...
yolo = YoloV3()
load_darknet_weights(yolo, 'C:/Users/k prem rathod/OneDrive/Desktop/projectnew/yolov3.weights') 
...
def webcamVideo():
    ...
    while(True):
        ...
        img = img / 255
        class_names = [c.strip() for c in open('C:/Users/k prem rathod/OneDrive/Desktop/projectnew/Classes.txt').readlines()]
